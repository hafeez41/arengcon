...
export default function Footer() {
  ...
  return (
    <footer style={{
      ...
      <p style={{ fontFamily: 'var(--sans)', fontSize: 9, letterSpacing: '0.25em', textTransform: 'uppercase' as const, color: 'var(--muted)' }}>
        © {year} Arengcon — Design &amp; Construction · All rights reserved
      </p>
      <div style={{ display: 'flex', gap: 20 }}>
        {['Privacy', 'Terms'].map(l => (
          <a key={l} href="#" className="link-slide"
            style={{ fontFamily: 'var(--sans)', fontSize: 9, letterSpacing: '0.25em', textTransform: 'uppercase' as const, color: 'var(--muted)', textDecoration: 'none', transition: 'color 0.3s' }}
